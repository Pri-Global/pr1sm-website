    ...
    <>
      ...
      <section className="relative section-alt section-padding overflow-hidden">
        ...
        <div className="relative z-10 container-wide max-w-3xl mx-auto">
          ...
          <div className="page-timeline space-y-10">
            {howItWorks.steps.map((step, i) => {
              const Icon = getIcon(step.icon)
              return (
                <div key={step.num} className="relative flex gap-6 pl-2">
                  <div className={`relative z-10 w-12 h-12 rounded-xl font-heading font-bold flex items-center justify-center shrink-0 text-white ${stepStyles[i]}`}>
